using Bob.Kiota.Client.WeatherForecast.Animals;
using Bob.Kiota.Client.WeatherForecast.EchoAnimals;
using Bob.Kiota.Client.WeatherForecast.Weather;
...
using System;
namespace Bob.Kiota.Client.WeatherForecast {
    /// <summary>
