...
using System;
namespace Bob.Kiota.Client2.WeatherForecast.Weather {
    /// <summary>
...
#nullable enable
        public async Task<List<Bob.Kiota.Client2.Models.WeatherForecast>?> GetAsync(Action<WeatherRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Bob.Kiota.Client2.Models.WeatherForecast>> GetAsync(Action<WeatherRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<Bob.Kiota.Client2.Models.WeatherForecast>(requestInfo, Bob.Kiota.Client2.Models.WeatherForecast.CreateFromDiscriminatorValue, default, cancellationToken);
